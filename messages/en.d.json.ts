...
declare const messages: {
  "app": {
    "/[locale]": {
      "metadata": {
        "title": "Template",
        "description": "Next js template with i18n, shadcn ui & dark theme, dashboard and blog"
      },
      "loading": {
        "ariaLabel": "loading..."
      },
    ...
    "/[locale]/blogs": {
      "metadata": {
        "title": "Blogs",
        "description": "Explore recent blog posts and insights."
      },
      "components": {
        "BlogsSection": {
          "title": "Blog Posts",
    ...
    "/[locale]/login": {
      ...
      "components": {
        "LoginForm": {
          ...
          "description": "Don't have an account? <a>Sign up</a>",
          "email": "Email",
          "password": "Password",
          "login": "Login",
          "or": "Or",
          ...
          "termsOfServiceAndPrivacyPolicy": "By clicking continue, you agree to our <TermsOfServiceLink>Terms of Service</TermsOfServiceLink> and <PrivacyPolicyLink>Privacy Policy</PrivacyPolicyLink>."
        }
      }
    }
  },
  "components": {
    ...
    "ui": {
      "sidebar": {
        ...
        "sidebarDescription": "Displays the sidebar.",
